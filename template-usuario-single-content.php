        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-lg-9 position-relative">
              <h2 class="mb-3"><i class="fa-light fa-file-lines me-1 text-primary"></i> Detalhes do pedido</h2>
              ...
              <div class="bg-white shadow rounded-3 p-4">
                ...
                <?php
                if (($post) and ($post->post_author == $current_user->ID)) {
                  ...
                  $pedido_link = get_permalink($post->ID);
                ...
                ?>
                          ...
                          <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $pedido_item_produto_nome; ?></td>
                  ...
                  <a href="<?php echo $pedido_link; ?>" target="_blank" class="btn btn-primary btn-sm float-end btn-print"><i class="fa-light fa-print"></i> Imprimir</a>
              </div>
              <!-- /.col-sm-12 -->
            </div>
            <!-- /.row -->
