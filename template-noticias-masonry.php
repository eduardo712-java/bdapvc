...
/**
 * Template Name: Template Notícias Masonry
 */
get_header();
?>
      ...
      <section class="pt-5">
        <article>
          <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 gy-5 gx-4 mb-5" data-masonry='{"percentPosition": true }'>
              ...
              ?>
                <div class="col-xl-4 col-md-6">
                  ...
                  <div class="card card-over overflow-hidden bg-white rounded-3 y-shadow">
