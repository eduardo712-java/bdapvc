          ...
          <div class="row">
            ...
            <div class="col-12 col-lg-12">
              ...
              <div class="p-4">
                ...
                $pedido_link_hash = $_GET["hash"];


                $args = array(
                  'post_type'  => 'pedido', // Ou o tipo de post personalizado
                  'meta_query' => array(
                    array(
                      'key'   => 'pedido_link_hash',  // Substitua pelo nome da meta_key
                      'value' => $pedido_link_hash,     // Substitua pelo valor desejado
                      'compare' => '='            // Operador de comparação (pode ser LIKE, >, <, etc.)
                    )
                  )
                );
